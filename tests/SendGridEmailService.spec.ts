...
describe ('#SendGridEmailService', () => {
  ...
  test('Can send mail from a nodemailer instance', async () => {
    ...
    sourceAddress = EmailAddress.create('test@gmail.com').getValue();
    destinationAddress = EmailAddress.create('testmircorservice@gmail.com').getValue();
    ...
    expect(sendgridMock.send.mock.calls[0]).toEqual([{"from": "test@gmail.com", "subject": "Hello world!", "text": "This is a message body", "to": "testmircorservice@gmail.com"}]);
